				...
				<div class="col-lg-4 course_box">
					...
					<div class="card">
						...
						<div class="price_box d-flex flex-row align-items-center">
							...
							<div class="course_price d-flex flex-column align-items-center justify-content-center"><span><a href=""><span><i class="material-icons" style="font-size:35px; color:white;margin-top:10px;">&#xe315;</i></span></a></span></div>
						</div>
					</div>
				</div>
					@endforeach
