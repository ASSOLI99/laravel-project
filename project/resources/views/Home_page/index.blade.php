				...
				<div class="row">
					...
					<div class="col-lg-4 hero_box_col">
						<div class="hero_box d-flex flex-row align-items-center justify-content-start">
							<img src="{{asset('layout/images/earth-globe.svg')}}" class="svg" alt="">
					...
					<div class="col-lg-4 hero_box_col">
						<div class="hero_box d-flex flex-row align-items-center justify-content-start">
							<img src="{{asset('layout/images/books.svg')}}" class="svg" alt="">
							<div class="hero_box_content">
					...
					<div class="col-lg-4 hero_box_col">
						<div class="hero_box d-flex flex-row align-items-center justify-content-start">
							<img src="{{asset('layout/images/professor.svg')}}" class="svg" alt="">
							<div class="hero_box_content">
		...
		<div class="container">
			...
			<div class="row course_boxes">
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						<img class="card-img-top" src="{{asset('layout/images/'.$item->book_image)}}" alt="https://unsplash.com/@kellybrito">
						<div class="card-body text-center">
							<!-- <div class="card-title"><a href="courses.html">{{$item->name}}</a></div>
							<div class="card-text">{{$item->book_description}}</div> -->
						</div>
						<div class="price_box d-flex flex-row align-items-center">
							<div class="course_author_image">
								<!-- <img src="{{asset('layout/images/author.jpg')}}" alt="https://unsplash.com/@mehdizadeh"> -->
							</div>
							<div class="course_author_name"><span>{{$item->book_genre}}</span></div>
							<!-- <div class="course_price d-flex flex-column align-items-center justify-content-center"><span>{{$item->name}}</span></div> -->
						</div>
					</div>
				</div>
@endforeach
			...
			<div class="row row-eq-height">
				...
				<div class="col-lg-6 nopadding">
					...
					<div class="search_section d-flex flex-column align-items-center justify-content-center">
						<div class="search_background" style="background-image:url({{asset('layout/images/search_background.jpg')}});"></div>
	...
	<div class="services page_section">
		...
		<div class="container">
			...
			<div class="row services_row">
				...
				<div class="col-lg-4 service_item text-left d-flex flex-column align-items-start justify-content-start">
					<div class="icon_container d-flex flex-column justify-content-end">
						<img src="{{asset('layout/images/professor.svg')}}" alt="">
					</div>
				...
				<div class="col-lg-4 service_item text-left d-flex flex-column align-items-start justify-content-start">
					<div class="icon_container d-flex flex-column justify-content-end">
						<img src="{{asset('layout/images/blackboard.svg')}}" alt="">
					</div>
					<h3>Top Programs</h3>
					<p>In aliquam, augue a gravida rutrum, ante nisl fermentum nulla, vitae tempor nisl ligula vel nunc. Proin quis mi malesuada, finibus tortor fermentum.</p>
				</div>
				...
				<div class="col-lg-4 service_item text-left d-flex flex-column align-items-start justify-content-start">
					<div class="icon_container d-flex flex-column justify-content-end">
						<img src="{{asset('layout/images/mortarboard.svg')}}" alt="">
					</div>
	...
	<div class="testimonials page_section">
		...
		<div class="testimonials_background_container prlx_parent">
			<div class="testimonials_background prlx" style="background-image:url({{asset('layout/images/testimonials_background.jpg')}})"></div>
		</div>
		<div class="container">
								...
								<div class="testimonials_item text-center">
									...
									<div class="testimonial_user">
										<div class="testimonial_image mx-auto">
											<img src="{{asset('layout/images/testimonials_user.jpg')}}" alt="">
										</div>
				...
				<div class="row event_item">
					<div class="col">
						<div class="row d-flex flex-row align-items-end">
							...
							<div class="col-lg-4 order-lg-3 order-1">
								<div class="event_image">
									<img src="{{asset('layout/images/event_3.jpg')}}" alt="https://unsplash.com/@juanmramosjr">
								</div>
							</div>
